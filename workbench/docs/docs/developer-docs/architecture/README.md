...
- **[Software Design Specification](./software-design-specification/README.md)** -- Design documents (functional, technical, synopsis)
- **[Extension Host](./extension-host.md)** -- vsix/ module structure, providers, commands, and data model
- **[WebView Application](../webview/README.md)** -- React/ShadCN UI, dual-context rendering, component architecture, Kitchen Sink

...
const mockFindings: FindingRow[] = [
  ...
  },
  {
    ...
    disposition: 'PENDING',
    scanner: 'semgrep',
    ruleId: 'javascript.browser.security.innerHTML',
  ...
  },
  {
    ...
    disposition: 'FIX',
    scanner: 'semgrep',
    ruleId: 'javascript.lang.security.insecure-transport',
  ...
  },
  {
    ...
    disposition: 'PENDING',
    scanner: 'semgrep',
    ruleId: 'javascript.express.security.missing-auth',
  ...
  },
  {
    ...
    filePath: 'infra/lib/database-stack.ts',
    startLine: 30,
    endLine: 38,
  ...
  },
  {
    ...
    disposition: 'PENDING',
    scanner: 'semgrep',
    ruleId: 'javascript.express.best-practice.cors',
    filePath: 'src/app.ts',
    startLine: 10,
    endLine: 10,
  ...
  },
  {
    ...
    disposition: 'SUPPRESS',
    scanner: 'semgrep',
    ruleId: 'javascript.lang.best-practice.hardcoded-config',
  ...
  },
  {
    ...
    disposition: 'PENDING',
    scanner: 'semgrep',
    ruleId: 'javascript.lang.best-practice.todo-security',
